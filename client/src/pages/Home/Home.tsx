        ...
        <div className="min-h-screen w-full bg-[#070707f7] text-white">
            ...
            <header className="h-17 border-b-2 border-zinc-900 flex items-center justify-between px-8">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div
                        className="w-8 h-8 rounded-full bg-teal-400 hover:bg-teal-300 flex items-center justify-center cursor-pointer"
                        title={user ? `${user.username} (${user.email})` : "Profile"}
                    >
